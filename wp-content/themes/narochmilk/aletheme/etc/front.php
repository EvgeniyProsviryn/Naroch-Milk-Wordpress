...
function ale_enqueue_styles() {
	...
	wp_register_style( 'light_css', THEME_URL . '/css/lightbox.css', array(), ALETHEME_THEME_VERSION, 'all');
	wp_register_style( 'boot_css', THEME_URL . '/css/bootstrap.min.css', array(), ALETHEME_THEME_VERSION, 'all');
...
function ale_enqueue_scripts() {
    ...
    wp_register_script( 'ale_parallax', THEME_URL . '/js/parallax.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_common', THEME_URL . '/js/common.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_boot', THEME_URL . '/js/bootstrap.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );
    wp_register_script( 'ale_light', THEME_URL . '/js/lightbox.min.js', array( 'jquery' ), ALETHEME_THEME_VERSION, true );

	wp_enqueue_script( 'jquery-form' );
	wp_enqueue_script( 'ale_modernizr' );
	wp_enqueue_script( 'html5-shim' );
	wp_enqueue_script( 'ale_parallax' );
	wp_enqueue_script( 'ale_common' );
	wp_enqueue_script( 'ale_boot' );
	wp_enqueue_script( 'ale_light' );
